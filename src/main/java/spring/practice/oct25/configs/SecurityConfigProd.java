...
public class SecurityConfigProd extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfigProd(UserDetailsServiceImpl userDetailsService) {
        System.out.println("loading Prod profiles for SecurityConfig");
    ...
    @Override
		protected void configure(HttpSecurity http) throws Exception {
			http.authorizeRequests()
                    .antMatchers("/journalV3-api/health-check").authenticated()
